...
GeantPy depends on **Geant4** with **Qt** and **OpenGL** visualization enabled.
---
...
GeantPy uses CERN ROOT as the simulation output format.
...
To view the summary of the latest run:
