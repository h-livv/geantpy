/// \file GeantpySession.cc
/// \brief Implementation of the GeantpySession class
...
GeantpySession::GeantpySession(int argc, char** argv)
    : fArgc(argc), fArgv(argv)
{
    ParseArguments();
}

GeantpySession::~GeantpySession()
{
...
void GeantpySession::ParseArguments()
{
...
void GeantpySession::Initialize()
{
    if (fIsInteractive) {
